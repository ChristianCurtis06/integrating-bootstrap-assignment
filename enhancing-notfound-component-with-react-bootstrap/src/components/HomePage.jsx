...
import { Container, Button, Image, Card, CardGroup } from 'react-bootstrap';

const HomePage = () => {
    return (
        /* Task 2: Applying Color Scheme */
        <Container fluid className='p-0 text-center border border-5 border-white' style={{boxSizing: 'border-box', backgroundColor: 'lightcoral', color: 'white'}}>
